...
$(function() {
  ...
  $.ajax({
    ...
    .then(function(data) {
      ...
      var yourLocation = 'South Beach, Miami Beach, FL 33139, USA';
  ...
  function getWeather(input) {
    ...
    requestWeather.done(function(data) {
      ...
      } else document.getElementById('weather').style.display = 'block';
     ...
     // $dt.html(fullDay(dt[0]) + ' ' + dt[4].substring(0, 5));
      ...
      $fahrenheit.on('click', toFahrenheit);
	   ...
	   $('#celc').html(Math.round((data.main.temp - 32) * (5 / 9)));
