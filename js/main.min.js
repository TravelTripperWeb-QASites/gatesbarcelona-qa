...
(function(Q, X, w) {
    ...
    function ha(b, a, c, d) {
        ...
        if (a) {
            ...
            a.lastIndex = b.lastIndex; else if (x(b.cloneNode)) a = b.cloneNode(!0); else return e = Object.create(rc(b)), 
            ha(b, e, c, d);
            d && (c.push(b), d.push(a));
        }
        return a;
    ...
    function ce() {
        ...
        if (!Bc) {
            ...
            (ra = v(a) ? Q.jQuery : a ? Q[a] : w) && ra.fn.on ? (B = ra, P(ra.fn, {
                ...
                var d;
                if (Qb) Qb = !1; else for (var e = 0, f; null != (f = a[e]); e++) (d = ra._data(f, "events")) && d.$destroy && ra(f).triggerHandler("$destroy");
                b(a);
            }) : B = R;
            da.element = B;
            Bc = !0;
    ...
    function rb(b) {
        for (var a = b[0], c = b[b.length - 1], d, e = 1; a !== c && (a = a.nextSibling); e++) if (d || b[e] !== a) d || (d = B(ua.call(b, 0, e))), 
        d.push(a);
        return d || b;
    }
    function fa() {
            ...
            G(a) ? (d(a), qb(f, "directiveFactory"), e.hasOwnProperty(a) || (e[a] = [], b.factory(a + "Directive", [ "$injector", "$exceptionHandler", function(b, d) {
                ...
                m(e[a], function(e, g) {
                    try {
                        ...
                        C(l.scope) && (!0 === l.bindToController ? (n.bindToController = c(l.scope, r, !0), 
        ...
        this.$get = [ "$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, d, u, q, z, N, ia, O, H) {
            ...
            function S(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    for (n = h.length; r < n; ) if (k = O[h[r++]], c = h[r++], f = h[r++], c) {
                        if (c.scope) {
                            if (l = a.$new(), W.$$addScopeInfo(B(k), l), t = c.$$destroyBindings) c.$$destroyBindings = null, 
                            l.$on("$destroyed", t);
                        } else l = a;
            ...
            function ca(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                  case pa:
                    ...
                    a = a.className;
                    C(a) && (a = a.animVal);
                    if (G(a) && "" !== a) for (;k = h.exec(a); ) l = ya(k[2]), na(b, l, "C", d, e) && (c[l] = T(k[3])), 
            ...
            function D(a, b, d, e, f, g, h, k, r) {
                ...
                for (var H = -Number.MAX_VALUE, S = r.newScopeDirective, ba = r.controllerDirectives, u = r.newIsolateScopeDirective, L = r.templateDirective, z = r.nonTlbTranscludeDirective, N = !1, m = !1, ia = r.hasElementTranscludeDirective, v = d.$$element = B(b), D, y, M, Ka = e, na, I = 0, F = a.length; I < F; I++) {
                    ...
                    u = D) : Q("new/isolated scope", u, D, v)), S = S || D;
                    y = D.name;
                    !D.templateUrl && D.controller && (M = D.controller, ba = ba || fa(), Q("'" + y + "' controller", ba[y], D, v), 
                    ba[y] = D);
                    if (M = D.transclude) N = !0, D.$$tlb || (Q("transclusion", z, D, v), z = D), "element" == M ? (ia = !0, 
                    H = D.priority, M = v, v = d.$$element = B(X.createComment(" " + y + ": " + d[y] + " ")), 
                    b = v[0], U(f, ua.call(M, 0), b), Ka = W(M, e, H, g && g.name, {
                        nonTlbTranscludeDirective: z
                    })) : (M = B(Ub(b)).contents(), v.empty(), Ka = W(M, e));
                    if (D.template) if (m = !0, Q("template", L, D, v), L = D, M = x(D.template) ? D.template(v, d) : D.template, 
                    M = ha(M), D.replace) {
                        g = D;
    ...
    function Xe() {
        ...
        this.$get = [ "$injector", "$window", function(c, d) {
            ...
            return function(f, h, g, l) {
                ...
                if (g) return g = (J(f) ? f[f.length - 1] : f).prototype, k = Object.create(g || null), 
    ...
    function af() {
        ...
        this.$get = [ "$parse", "$exceptionHandler", "$sce", function(c, d, e) {
            ...
            function g(f, g, n, p) {
                ...
                p = !!p;
                for (var q, m, N = 0, s = [], O = [], H = f.length, L = [], W = []; N < H; ) if (-1 != (q = f.indexOf(b, N)) && -1 != (m = f.indexOf(a, q + l))) N !== q && L.push(h(f.substring(N, q))), 
                N = f.substring(q + l, m), s.push(N), O.push(c(N, u)), N = m + k, W.push(L.length), 
                L.push(""); else {
            ...
            return function(d, k, E) {
                ...
                switch (typeof d) {
                  case "string":
                    ...
                    var s = E ? a : b;
                    m = s[q];
                    m || (":" === d.charAt(0) && ":" === d.charAt(1) && (u = !0, d = d.substring(2)), 
        ...
        P(h.prototype, {
            ...
            $$resolve: function(b) {
                ...
                try {
                    ...
                    x(d) ? (this.promise.$$state.status = -1, d.call(b, e[0], e[1], this.notify)) : (this.promise.$$state.value = b, 
                    ...
                    do {
                        ...
                        a: do {
                            if (k = m.$$watchers) for (n = k.length; n--; ) try {
                                ...
                                d = b, b.last = b.eq ? ha(f, null) : f, b.fn(f, g === E ? f : g, m), 5 > t && (D = 4 - t, 
                                u[D] || (u[D] = []), u[D].push({
    ...
    function yd(b) {
        ...
        return function() {
            ...
            l = h.indexOf("="), 0 < l && (k = a(h.substring(0, l)), v(d[k]) && (d[k] = a(h.substring(l + 1))));
            return d;
        };
    }
    function zf() {
    ...
    function Dd(b, a, c, d, e) {
        ...
        if (h || k) 0 < e && 1 > b && (l = b.toFixed(e), b = parseFloat(l), l = l.replace(hc, d)); else {
            ...
            if (g.length >= r + t) for (p = g.length - r, k = 0; k < p; k++) 0 === (p - k) % t && 0 !== k && (l += c), 
            l += g.charAt(k);
    ...
    function Hd(b) {
        ...
        d.$setValidity = function(b, e, f) {
            ...
            g(d.$$success, b, f));
            d.$pending ? (a(Md, !0), d.$valid = d.$invalid = w, c("", null)) : (a(Md, !1), d.$valid = Ld(d.$error), 
    ...
    m({
        ...
        attr: function(b, a, c) {
            var d = b.nodeType;
            if (d !== Pa && 2 !== d && 8 !== d) if (d = F(a), Bb[d]) if (A(c)) c ? (b[a] = !0, 
            b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || y).specified ? d : w; else if (A(c)) b.setAttribute(a, c); else if (b.getAttribute) return b = b.getAttribute(a, 2), 
            null === b ? w : b;
        },
        prop: function(b, a, c) {
    ...
    m({
        ...
        R.prototype[c] = function(c, e, f) {
            for (var h, g = 0, l = this.length; g < l; g++) v(h) ? (h = a(this[g], c, e, f), 
    ...
    var pg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, Tf = {
        ...
        search: function(a, c) {
            switch (arguments.length) {
              ...
              case 1:
                if (G(a) || V(a)) a = a.toString(), this.$$search = yc(a); else if (C(a)) a = ha(a, {}), 
                m(a, function(c, e) {
                    null == c && delete a[e];
    ...
    td.prototype = {
        ...
        computedMember: function(a, c, d, e, f) {
            return function(h, g, l, k) {
                var n = a(h, g, l, k), p, m;
                null != n && (p = c(h, g, l, k), p = kd(p), Xa(p, f), e && 1 !== e && n && !n[p] && (n[p] = {}), 
                m = n[p], Ba(m, f));
                return d ? {
                    context: n,
                    name: p,
                    ...
                    return {
                        pre: function(a, d, f, h) {
                            ...
                            g && (s(a, m), f.$observe(g, function(c) {
                                m.$name !== c && (s(a, w), m.$$parentForm.$$renameControl(m, c), s = e(m.$name), 
                                s(a, m));
                            }));
                            d.on("$destroy", function() {
    ...
    var xe = [ "$animate", function(a) {
        ...
        return {
            ...
            controller: [ "$scope", "$attrs", function(a, c) {
                ...
                A(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, this.$options.updateOn = T(this.$options.updateOn.replace(yg, function() {
        ...
        return {
            link: function(h, g, l) {
                ...
                h.$watch(n, function(c) {
                    ...
                    e === x || f && V(x) && isNaN(x) || (z(), f = w[e], v(f) ? (null != c && d.debug("ngPluralize: no rule defined for '" + e + "' in " + p), 
            ...
            compile: function(f, h) {
                ...
                return function(a, f, h, k, n) {
                    ...
                    a.$watchCollection(p, function(h) {
                        ...
                        C = I.length;
                        L = Array(C);
                        for (k = 0; k < C; k++) if (G = h === I ? k : I[k], J = h[G], M = p(G, J, k), s[M]) F = s[M], 
                        delete s[M], x[M] = F, L[k] = F; else {
...
angular.module("ui.date", []).constant("uiDateConfig", {}).directive("uiDate", [ "uiDateConfig", "uiDateConverter", function(uiDateConfig, uiDateConverter) {
    "use strict";
    var options;
    options = {};
    ...
    return {
        ...
        link: function(scope, element, attrs, controller) {
            ...
            var initDateWidget = function() {
                ...
                var opts = getOptions();
                function setVal() {
                    var keys = [ "Hours", "Minutes", "Seconds", "Milliseconds" ], isDate = angular.isDate(controller.$modelValue), preserve = {};
...
} ]).constant("uiDateFormatConfig", "").directive("uiDateFormat", [ "uiDateConverter", function(uiDateConverter) {
    var directive = {
        require: "ngModel",
...
(function() {
    angular.module("rezTrip", [ "ui.date" ], function($interpolateProvider) {
...
angular.module("rezTrip").service("rt3HotelInfo", [ "$rootScope", "$q", "rt3api", function($rootScope, $q, rt3api) {
    ...
    RoomDetails.prototype.fetchRoomDetails = function() {
        ...
        var roomId = {
            room_id: dataRoomId || $location.path().substr(1)
        };
...
(function(root, factory) {
    ...
    function handleTweets(tweets) {
        if (customCallbackFunction === null) {
            ...
            while (n < x) {
                if (n < 2) {
                    html += '<div class="col-sm-4 col-md-3">' + tweets[n] + '</div></a></div><div class="col-sm-4 col-md-3 photolist' + n + '"></div>';
                } else {
                    html += '<div class="col-sm-4 col-md-3 photolist' + n + '"></div><div class="col-sm-4 col-md-3">' + tweets[n] + "</div> </div>";
                }
                n++;
            }
            html += "</div>";
            ...
            if (dataOnly) {
                ...
                while (n < x) {
                    ...
                    if (parseLinks) {
                        ...
                        if (printUser) {}
                        op += '<div class="feed-text"><a href="' + permalinksURL[n] + '" target="_blank"><h2 class="label-1">@GATES HOTEL DIAGONAL</h2> <div class="icon-t"><i class="fa fa-twitter" aria-hidden="true"></i></div><p class="label-2">' + strip(tweets[n].innerHTML) + "</p>";
                        if (printTime) {
                            if (permalinks) {
                                op += '<div class="label-3"><span class="label-date">' + times[n].getAttribute("aria-label") + "</span></div>";
                            } else {
                                op += '<div class="label-3"><span class="label-date">' + times[n].getAttribute("aria-label") + "</span></div>";
                            }
                        }
                        ...
                        if (tweets[n].textContent) {
                            if (printUser) {
                                op += '<span class="label-twitter">' + authors[n].textContent + "</span></div></div></a>";
                            }
